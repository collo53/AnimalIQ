...
const Arctic = () => {
  ...
  useEffect(() => {
    const fetchOceanAnimals = async () => {
      try {
        const res = await axios.get("https://animals-production-13e6.up.railway.app/animals/animals/category/arctic-animals/");
    ...
    <div className="min-h-screen bg-background">
      <section className="relative h-screen flex items-center justify-center">
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1690150421558-b0e78fde97cf?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}
        >
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          <div className="flex items-center justify-center mb-6">
            ...
            <h1 className="text-6xl md:text-7xl font-bold">Arctic World</h1>
          </div>
          <p className="text-xl md:text-2xl mb-8 leading-relaxed">
            Dive into the wonders of Arctic life.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover the amazing animals that call the icy lands of the earth   their home.
            </p>
          </div>

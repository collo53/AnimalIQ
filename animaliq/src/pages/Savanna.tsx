...
import { MapPin, Leaf, Globe, Droplets, Trees } from "lucide-react";
...
const Savanna = () => {
  ...
  useEffect(() => {
    const fetchOceanAnimals = async () => {
      try {
        const res = await axios.get("https://animals-production-13e6.up.railway.app/animals/animals/category/savanna-animals/");
    ...
    <div className="min-h-screen bg-background">
      <section className="relative h-screen flex items-center justify-center">
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1601625463687-25541fb72f62?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')` }}
        >
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          <div className="flex items-center justify-center mb-6">
            <Trees className="h-12 w-12 mr-4 text-accent" />
            <h1 className="text-6xl md:text-7xl font-bold">Savanna World</h1>
          </div>
          <p className="text-xl md:text-2xl mb-8 leading-relaxed">
            Dive into the wonders of savanna life.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover the amazing animals that call the grasslands their home.
            </p>
          </div>
